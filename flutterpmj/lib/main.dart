...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final _num2control = TextEditingController();
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          // horizontal).
          mainAxisAlignment: MainAxisAlignment.start,//change gravity
          children: <Widget>[
            Padding(
              padding: EdgeInsets.all(16.0),
              child: Image(image: AssetImage('assets/kuislogo.png')),
            ),
            //add TextField here
          Padding(
            padding: EdgeInsets.all(16.0),
